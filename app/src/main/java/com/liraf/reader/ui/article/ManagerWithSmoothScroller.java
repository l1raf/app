...
public class ManagerWithSmoothScroller extends LinearLayoutManager {
    ...
    public ManagerWithSmoothScroller(Context context) {
    ...
    private class TopSnappedSmoothScroller extends LinearSmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int targetPosition) {
            return ManagerWithSmoothScroller.this
